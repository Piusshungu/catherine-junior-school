...
<label class="text-sm font-medium text-gray-500 block mb-2" for="students_details">
    Upload Students file
</label>

<div class="relative">
    <input class="block w-full overflow-hidden cursor-pointer bg-gray-50 border-gray-300" />
</div>

<div class="mt-1 text-sm text-gray-500" id="students_details">

Make sure your file is in Excel format
