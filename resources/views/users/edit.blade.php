            ...
            <form method="POST" action="/user/{{ $user->id }}/edit" enctype="multipart/form-data">
                ...
                <div class="flex w-full mx-3 mb-6 mt-10 content-center">
                    ...
                    <div class="w-full px-3 mb-6 md:mb-0">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-yellow-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="first_name" name="first_name" type="text" value="{{ $user->first_name }}" placeholder="First Name">
                        <p class="text-gray-500 text-xs italic">Type to Edit First Name</p>
                    ...
                    <div class="w-full px-3 mx-6">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-yellow-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="last_name" name="last_name" type="text" value="{{ $user->last_name }}" placeholder="Last Name">
                        <p class="text-gray-500 text-xs italic">Type to Edit Last Name</p>
                    </div>
                ...
                <div class="flex w-full mx-3 mb-6 mt-10 content-center">
                    ...
                    <div class="w-full px-3 mb-6 md:mb-0">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-yellow-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="email" type="email" name="email" value="{{ $user->email }}" placeholder="Email Address">
                        <p class="text-gray-500 text-xs italic">Type to Edit Email</p>
                    </div>
                    ...
                    <div class="w-full px-3 mx-6">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-yellow-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="phone_number" name="phone_number" type="text" value="{{ $user->phone_number }}" placeholder="Phone Number">
                        <p class="text-gray-500 text-xs italic">Type to Edit Phone Number</p>
                    </div>
                </div>
                ...
                <div class="flex w-full mx-3 mb-6 mt-10 content-center">
                    ...
                    <div class="w-full px-3 mb-6 md:mb-0 ">
                        ...
                        <select id="roles" name="type" multiple placeholder="Edit User Role" autocomplete="off" class="focus:ring-blue-500 w-full rounded-lg cursor-pointer focus:outline-none" multiple>
