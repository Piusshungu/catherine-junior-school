        ...
        <div class="inline-block ml-10 w-full align-middle border-b border-gray-200 shadow sm:rounded-lg">
            ...
            <div class="border-b border-gray-200 dark:border-gray-700">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400 ml-12">
                    <li class="mr-2">
                        <a href="/users/notifications/email" class="inline-flex p-4 rounded-t-lg border-b-4 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group">
                    ...
                    <li class="mr-2">
                        <a href="/users/notifications/sms" class="inline-flex p-4 text-blue-600 rounded-t-lg border-b-4 border-gray-400 active dark:text-blue-500 dark:border-blue-500 group" aria-current="page">
