...
<body>
    ...
    <header class="bg-white" x-data="{ isOpen: false }">
        <nav class="container px-8 py-4 mx-auto md:flex md:justify-between md:items-center">
            ...
            <div :class="isOpen ? 'flex' : 'hidden'" class="flex-col mt-2 space-y-4 md:flex md:space-y-0 md:flex-row md:items-center md:space-x-10 md:mt-0">
                ...
                <a class="px-4 py-2 text-center text-white border bg-gray-600 from-yellow-300 to-yellow-500 rounded-full hover:shadow-xl" href="#">Contact
                    Us</a>
            </div>
        </nav>
    </header>
    ...
    <footer id="newsLetter" class="rounded -xl heigh bg-gray-100 border border-black border-opacity-5 text-center py-16 px-10 mt-16 bg-gray-400">
        ...
        <div class="mt-10">
            <div class="relative inline-block mx-auto lg:bg-gray-200 rounded-full">
                ...
                <form method="POST" action="#" class="lg:flex text-sm">
                    ...
                    <button type="submit" class="transition-colors duration-300 bg-yellow-400 hover:bg-blue-600 mt-4 lg:mt-0 lg:ml-3 rounded-full text-xs font-semibold text-white uppercase py-3 px-8">
                        Subscribe
                    </button>
                </form>
            </div>
