    ...
    <header class="bg-white" x-data="{ isOpen: false }">
        <nav class="container px-8 py-4 mx-auto md:flex md:justify-between md:items-center">
            ...
            <div :class="isOpen ? 'flex' : 'hidden'" class="flex-col mt-2 space-y-4 md:flex md:space-y-0 md:flex-row md:items-center md:space-x-10 md:mt-0">
                ...
                <a class="px-4 py-2 text-center text-white bg-yellow-400 from-yellow-300 to-yellow-500 rounded-full hover:shadow-xl" href="#">Get
                    Started</a>
            </div>
        </nav>
    </header>
    ...
    <footer class="text-center bg-gray-800 text-white">
        <div class="container px-6 pt-6">
            ...
            <div>
              ...
              " id="contact-us" placeholder="Email address" />
                        </div>
            ...
            <div class="grid lg:grid-cols-3 md:grid-cols-2">
                <div class="mb-6 col">
                    <h5 class="uppercase font-bold mb-2.5">Contacts</h5>
                    ...
                    <li>
                            ...
                            <a href="#!" class="text-white">shungupius@gmail.com</a>
                        </li><br>
                        ...
                        <li>
                            ...
                            <a href="#!" class="text-white">+255714262024</a>
                        ...
                        <li>
                            <svg xmlns="http://www.w3.org/2000/svg" class="inline-block h-6 w-6 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                            </svg>:
                            <a href="#!" class="text-white">P.O Box 1078 DSM</a>
                        </li>
                ...
                <div class="mb-6 col">
                    ...
                    <ul class="list-none mb-0">
                        <li>
                            ...
                            <a href="#!" class="text-white">Tanzania, Dar es Salaam</a>
                        </li>
                        <li>
                            <a href="#!" class="text-white">Mabibo Luhanga</a>
                        </li>
                    </ul>
                </div>

                <div class="mb-6 col ml-0">
                    <h5 class="uppercase font-bold mb-2.5 ml-0">Updates</h5>
                    ...
                    <ul class="list-none mb-0">
                        ...
                        <li>
                            ...
                            <a href="#!" class="text-white">Results</a>
                        </li><br>
                        <li>
                            <svg xmlns="http://www.w3.org/2000/svg" class="inline-block h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.2);">
            © 2021 Copyright:
            <a class="text-white" href="https://tailwind-elements.com/">Catherine Junior School</a>
        </div>
    </footer>