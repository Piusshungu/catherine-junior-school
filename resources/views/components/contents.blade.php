        ...
        <!-- hero section -->
        <section class="bg-yellow-400 flex justify-content-between">
        <div class="">
                            <img src="/images/children_at_school.jpg" alt="" class="absolute rounded-l-full right-0 h-3/4 w-1/2"></img>
                        </div>
            <div class="flex justify-center">
                ...
                <div class="px-20 py-32 lg:w-1/2">
                    <div class="w-full ">
                        ...
                        <h1 class="mb-2 text-4xl font-small text-gray-900">Welcome to Catherine Junior School
                        </h1>
                        <div class="leading-relaxed">The Home of better and wonderful Education for your Child. We offer better Education for different classes </div>
                        <button
                            class="px-8 py-2 mt-4 text-xl text-white hover:shadow-2xl bg-gray-600 rounded-full">Get
                            started</button>
                    </div>
                ...
                <div class="flex flex-wrap m-4 text-center">
                    <div class="w-full p-4 lg:w-1/3">
                        <div class="px-4 py-6 border-2 border-gray-200 rounded-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-20 h-20 mb-3 text-yellow-300"
